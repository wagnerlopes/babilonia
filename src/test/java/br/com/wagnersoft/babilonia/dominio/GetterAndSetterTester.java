...
/**
 * Class to test using JUnit the getters and setters of a class.
 * The basic usage is to test the methods (matching beans naming conventions)
 * of a given object, using {@code testInstance(instance)}, or a given class, with
 * {@code testClass(clazz)}.
 * As it works by instantiating the classes to test, and those to get and set the fields,
 * if a class is too complex to instantiate, functinoality is provided to ignore specific
 * fields or store default instances of the classes to use.
 *
...
public class GetterAndSetterTester {
    ...
    public GetterAndSetterTester() {
        ...
        defaultInstances.put(boolean.class, Boolean.valueOf(true));
        defaultInstances.put(byte.class, Byte.valueOf("0"));
        defaultInstances.put(char.class, Character.valueOf('0'));
        defaultInstances.put(short.class, Short.valueOf("0"));
        defaultInstances.put(int.class, Integer.valueOf(0));
        defaultInstances.put(long.class, Long.valueOf("0"));
        defaultInstances.put(float.class, Float.valueOf("0"));
    ...
    private void testGetterAndSetter(final Field field, final Object instance) {
        ...
        try {
            ...
            assertEquals(value, getter.invoke(instance), "Failed getter and setter test of field " + field.getName() + " on classs " + field.getDeclaringClass().getName());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void testSetter(final Field field, final Object instance) {
        ...
        try {
            ...
            assertEquals(value, field.get(instance), "Failed setter test of field " + field.getName() + " on classs " + field.getDeclaringClass().getName());
    ...
    private void testGetter(final Field field, final Object instance) {
        ...
        try {
            ...
            assertEquals(value, getter.invoke(instance), "Failed getter test of field " + field.getName() + " on classs " + field.getDeclaringClass().getName());
