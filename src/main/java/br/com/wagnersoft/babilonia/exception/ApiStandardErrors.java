...
@ApiResponses(value = {
    @ApiResponse(responseCode = "400", description = "Requisição inválida: verifique os parâmetros enviados.",
      content = @Content(schema = @Schema(implementation = WSResultDTO.class),
      examples = @ExampleObject(value = "{ \"situacaoCodigo\": 99, \"situacaoDescricao\": \"Requisição inválida: informe um CPF válido.\", \"consultaData\": \"2026-07-19\" }"))),
    ...
    @ApiResponse(responseCode = "404", description = "Recurso não localizado.",
      content = @Content(schema = @Schema(implementation = WSResultDTO.class),
      examples = @ExampleObject(value = "{ \"situacaoCodigo\": 99, \"situacaoDescricao\": \"Não existe cidadão com o CPF informado.\", \"consultaData\": \"2026-07-19\" }"))),
